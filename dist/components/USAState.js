(function (global, factory) {
  ...
  var USAState = function USAState(props) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "text",
        { textAnchor: "middle", className: "state", style: { pointerEvents: "none" }, x: textX, y: textY },
        props.state
      ),
      _react2.default.createElement(
        "text",
        { textAnchor: "middle", className: "state-name", s: true, style: { pointerEvents: "none" }, x: textX, y: textY },
        props.stateName
      )
    );
  };
