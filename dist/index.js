(function (global, factory) {
  ...
  var USAMap = function (_React$Component) {
    ...
    function USAMap() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = USAMap.__proto__ || Object.getPrototypeOf(USAMap)).call.apply(_ref, [this].concat(args))), _this), _this.clickHandler = function (stateAbbreviation) {
      ...
      }, _this.strokeStateColor = function (state) {
        if (_this.props.customize && _this.props.customize[state] && _this.props.customize[state].stroke) {
          return _this.props.customize[state].stroke;
        }

        return _this.props.defaultStroke;
        ...
        for (var stateKey in _usaMapDimensions2.default) {
          var path = _react2.default.createElement(_USAState2.default, { key: stateKey, stateName: _usaMapDimensions2.default[stateKey].name, dimensions: _usaMapDimensions2.default[stateKey]["dimensions"], offset: _usaMapDimensions2.default[stateKey]["offset"], state: stateKey, fill: _this.fillStateColor(stateKey), stroke: _this.strokeStateColor(stateKey), onClickState: _this.stateClickHandler(stateKey), onMouseOverState: _this.stateMouseOverHandler(stateKey) });
          paths.push(path);
        };
        return paths;
      ...
      value: function render() {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "g",
              { className: "DC state", transform: "translate(801.8,253.8)" },
              _react2.default.createElement("path", { className: "DC1", fill: this.fillStateColor("DC1"), d: "M0,0 l-1.1-1.6 -1-0.8 1.1-1.6 2.2,1.5z" }),
              _react2.default.createElement(
                "circle",
                { className: "DC2", onClick: this.clickHandler, onMouseOver: this.mouseOverHandler, "data-name": "DC", fill: this.fillStateColor("DC2"), stroke: "#FFFFFF", strokeWidth: "1.5", cx: "801.3", cy: "251.8", r: "5", opacity: "1" },
                _react2.default.createElement(
                  "title",
                  null,
  ...
  USAMap.propTypes = {
    ...
    defaultStroke: _propTypes2.default.string,
